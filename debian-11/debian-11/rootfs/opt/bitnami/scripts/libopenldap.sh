...
# Settings
export LDAP_PORT_NUMBER="${LDAP_PORT_NUMBER:-389}"
export LDAP_LDAPS_PORT_NUMBER="${LDAP_LDAPS_PORT_NUMBER:-636}"
export LDAP_ROOT="${LDAP_ROOT:-dc=techtel,dc=com}"
export LDAP_ADMIN_USERNAME="${LDAP_ADMIN_USERNAME:-adminuser}"
...
export LDAP_CONFIG_ADMIN_USERNAME="${LDAP_CONFIG_ADMIN_USERNAME:-adminuser}"
...
export LDAP_USERS="${LDAP_USERS:-edsonjosh}"
export LDAP_PASSWORDS="${LDAP_PASSWORDS:-edson}"
export LDAP_USER_DC="${LDAP_USER_DC:-users}"
export LDAP_GROUP="${LDAP_GROUP:-developers}"
...
objectClass: olcDatabaseConfig
olcDatabase: monitor
olcAccess: to * by dn.base="gidNumber=0+uidNumber=0,cn=peercred,cn=external,cn=auth" read by dn.base="cn=techtel,dc=techtel,dc=com" read by * none
...
olcSuffix: dc=techtel,dc=com
olcRootDN: cn=Admin,dc=techtel,dc=com
olcMonitoring: FALSE
